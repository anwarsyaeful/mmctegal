...
class Transaksi extends ci_controller
{
    ...
    function excel()
    {
        ...
        $data['record'] =  $this->Model_transaksi->laporan_default();
        $this->load->view('superadmin/laporan_excel', $data);
    ...
    function print_transaksi()
    {
        ...
        $html = $this->load->view('superadmin/transaksi/print_transaksi', $data, true);
    ...
    public function hapus()
 	{
 		$where = array('transaksi_id');
		$this->M_Mmc->delete_data($where, 'transaksi');
		$this->session->set_flashdata('pesan','<div class="alert alert-danger alert-dismissible fade show" role="alert">
				Data laporan penjualan berhasil dihapus
				  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				    <span aria-hidden="true">&times;</span>
			  </button>
			</div>');
