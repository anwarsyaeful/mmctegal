<div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Form Input Data Menu</h1>
          </div>

		  <div class="card">
		   	<div class="card-body">

		   		<form method="POST" action="<?php echo base_url('superadmin/data_menu/tambah_menu_aksi') ?>" enctype="multipart/form-data">
		   		<div class="row">
		   			<div class="col-md-6">
		   				...
		   				<div class="form-group">
		   					<label>Nama</label>
		   					<input type="text" name="nama_mn" class="form-control">
		   					<?php echo form_error('nama_mn','<div class="text-small text-danger">','</div>') ?>
		   				</div>

		   				<div class="form-group">
		   					<label>Jenis</label>
		   					<select name="ket_mn" class="form-control">
		   						<option value="ice">ice</option>
		   						<option value="hot">hot</option>
		   						<?php echo form_error('ket_mn','<div class="text-small text-danger">','</div>') ?>
		   					</select>
		   				</div>

		   				<div class="form-group">
		   					<label>Harga</label>
		   					<input type="number" name="harga_mn" class="form-control">
